...
function Contact() {
  return (
    <div className=" w-full h-screen ">
      <h2 className=" text-[30px] md:text-[40px] text-primary font-bold">Contact Me</h2>
      <div className=" w-full flex flex-col items-center ">
        <div className="w-full h-full flex flex-col items-center mt-5">
          <h4 className=" text-primary text-[26px]">Have you any Qestions ?</h4>
        ...
        <div className="flex flex-col lg:flex-row  items-center gap-10 lg:gap-26 pl-10 mt-10 lg:mt-16">
          {/* call div */}
          <div>
            <IoCall className="contact_icon text-primary text-[40px]" />
            <h5 className="text-[20px] font-bold">Call Us On</h5>
            <p>Phone: +971 55 555 5555</p>
          </div>
          {/* location div */}
          <div>
            <IoLocationSharp className="contact_icon text-primary text-[40px]" />
            <h5 className="text-[20px] font-bold">Office</h5>
            <p>1700 Street, Gazipur, Joydebpur</p>
          </div>
          {/* email div */}
          <div>
            <MdEmail className="contact_icon text-primary text-[40px]" />
            <h5 className="text-[20px] font-bold">Email</h5>
            <p>sbsakibsarkar8@gmail.com</p>
          </div>
          {/* website div */}
          <div>
            <TbWorld className="contact_icon text-primary text-[40px]" />
        ...
        <div className="w-full h-full flex flex-col items-center my-10 lg:my-26">
          <h4 className=" text-primary text-[26px]">SEND ME AN EMAIL</h4>
