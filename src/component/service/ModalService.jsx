...
<dialog id={`modal${id}`} className="modal">
  <div className="modal-box">
    ...
    <p className="py-4 text-[17px] leading-[30px]">{description}</p>
  ...
  <hr />
  <p className="text-[20px] mt-2">Feel free to contact me, If you are interested in me. I'll reply instantly if I'm available.....
...
<button className="btn bg-primary outline-0  shadow-lgs" onClick={()=>document.getElementById("modal"+id).showModal()}>Show more</button>
</>
  )
}
