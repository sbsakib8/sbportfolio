  ...
  return (
    <div className=' w-full flex flex-col  lg:flex-row gap-11'>
      <div className="w-full lg:w-[50%] flex flex-col  items-center" >
        ...
        <p  className="rerume_paragraph">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem incidunt facere dolor dicta illo doloribus, commodi fugit rerum quas error!</p>
      <Button/>
      </div>
