...
function Navber({ children }) {
    ...
    return (
        <div className="flex flex-col md:flex-row">
            {/* Sidebar */}
            <div className={`${open ? 'md:w-72' : 'md:w-16 w-16'} duration-500 h-[400px] md:h-full bg-[#222222] bottom-30 md:bottom-0 fixed md:left-0 md:top-0 px-3 z-20 rounded-full md:rounded-none`}>
                ...
                <div className='flex flex-col mt-9 md:mt-20 gap-5'>
